# Generated by Powerlevel10k configuration wizard on 2023-03-23 at 03:28 EDT.
...
# Generated by Powerlevel10k configuration wizard on 2023-03-20 at 04:18 EDT.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 01951.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='REMOTE: %n'
  ...
  function prompt_remote() {
    if [[ $_P9K_SSH -eq "1" ]]; then
      local state=true
    else
      local state=false
    fi
    p10k segment -f red -s $state
  }

  typeset -g POWERLEVEL9K_REMOTE_
